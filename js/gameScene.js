class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.levelText = this.add.text(35, 25, `Уровень: ${gameSettings.currentLevel}`, {
            fontSize: '20px', fill: '#ffffff', fontFamily: 'Arial, Helvetica, sans-serif', stroke: '#000', strokeThickness: 3
        }).setDepth(11);
    ...
    pauseGame() {
        ...
        const resumeText = this.add.text(400, 320, 'ПРОДОЛЖИТЬ', {
            fontSize: '24px', fill: '#fff', fontFamily: 'Arial, Helvetica, sans-serif', stroke: '#000', strokeThickness: 3
    ...
    generateMathProblem() {
        ...
        this.problemText = this.add.text(400, 475, this.currentProblem.question, {
            fontSize: '36px', fill: '#ffffff', fontFamily: 'Arial, Helvetica, sans-serif',
        ...
        answers.forEach((ans, i) => {
            ...
            const txt = this.add.text(x, y, ans.toString(), {
                fontSize: '24px', fill: '#ffffff', fontFamily: 'Arial, Helvetica, sans-serif',
    ...
    levelComplete() {
        ...
        this.time.delayedCall(2000, () => {
            // После каждого уровня показываем карту
    ...
    showHeroMessage(msg) {
        ...
        this.heroMessage = this.add.text(this.hero.x + 60, this.hero.y - 50, msg, {
            fontSize: '20px', fill: '#ffffff', fontFamily: 'Arial, Helvetica, sans-serif',
